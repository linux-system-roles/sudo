...
- ci: use gha checkout v7, codecov v7 [citest_skip] (#127)
- ci: bump actions/checkout from 6 to 7 (#128)
- ci: Use our own pr_title_lint.py instead of NPM commitlint [citest_skip] (#129)
- ci: bump tox-lsr version to 3.20.0 to fix tox 4.58 api breakage [citest_skip] (#130)
- ci: Add support for Fedora 44 and drop Fedora 42 - use ansible-core 2.21 [citest_skip] (#132)
- ci: bump actions/setup-python from 6 to 7 (#133)
- ci: bump github/codeql-action from 4 to 4.37.3 (#134)
- ci: ensure dependabot updates do not invoke ci tests [citest_skip] (#135)
- ci: [citest_skip] bump github/codeql-action from 4.37.3 to 4.37.4 (#136)
